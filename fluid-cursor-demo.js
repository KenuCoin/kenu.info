    ...
    const initFluid = () => {
      ...
      function showFallback(msg){
        ...
        if (msg) f.textContent = msg; f.style.display = 'grid';
      }
      ...
      if (!ctx || !ctx.gl){ showFallback('WebGL zgasł. Spróbuj inną przeglądarkę.'); return; }
      const { gl, ext } = ctx;
      ...
      function createProgram(vertexShader, fragmentShader) {
        ...
        // BIND aPosition -> attrib 0 to avoid black screen on some drivers
